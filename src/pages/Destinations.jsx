      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
        {filteredPackages.map((pkg) => (
          <motion.div 
            ...
            key={pkg.id} className="group cursor-pointer"
          ...
          >
            <div className="aspect-square rounded-[40px] overflow-hidden mb-6 border border-white/5 relative shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 bg-white text-forest px-4 py-2 rounded-full font-black text-[9px] uppercase tracking-widest shadow-xl">${pkg.price}</div>
            </div>
        ...
        {selectedPkg && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/90 backdrop-blur-md" onClick={() => setSelectedPkg(null)}>
            <motion.div 
              ...
              className="bg-[#0B1812] border border-white/10 w-full max-w-lg rounded-[40px] p-8 relative shadow-2xl"
            ...
            >
              ...
              <p className="text-mint text-[10px] font-black uppercase mb-6 italic">📍 {selectedPkg.location}</p>
